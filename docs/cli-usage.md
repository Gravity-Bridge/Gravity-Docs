...
```bash
gravity tx gravity send-to-eth 0xDESTINATIONONETH 100graviton 5graviton --node https://gravitychain.io:26657 --fees 0ugraviton
```
...
```bash
gravity tx ibc-transfer transfer transfer transfer channel-2 osmosis1ADDRESS 10graviton
```
