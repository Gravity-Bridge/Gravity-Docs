...
wget https://github.com/Gravity-Bridge/Gravity-Bridge/releases/download/v1.13.3/gravity-linux-amd64
mv gravity-linux-amd64 gravity

# Tools for the gravity bridge from the gravity repo

wget github.com/Gravity-Bridge/Gravity-Bridge/releases/download/v1.13.3/gbt
chmod +x *
sudo mv * /usr/bin/
...
NOTE: Since these instructions were created, various changes and updates have come and gone. Visit [geth.ethereum.org](https://geth.ethereum.org/) for the latest binary and instructions.
