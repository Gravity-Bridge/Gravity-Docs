...
wget https://github.com/Gravity-Bridge/Gravity-Bridge/releases/download/v1.4.2/gbt
chmod +x *
sudo mv * /usr/bin/
...
to check what version of the tools you have run `gbt --version` the current latest version is `gbt 1.4.2`
