...
[Estimating Gravity Bridge to Ethereum Fees]
[Estimating Ethereum to Gravity Bridge Fees]
[Monitoring sends from Ethereum to Gravity Bridge]
[Monitoring sends from Gravity Bridge to Ethereum]
[Monitoring the Gravity Bridge fee market]
...
This will give you a gas cost in wei, convert this value to the equivalent cost in the bridged token.
